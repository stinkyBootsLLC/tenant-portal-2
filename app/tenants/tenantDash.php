  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item">
                <span class="nav-link active" aria-current="page"><ion-icon name="home"></ion-icon>&nbsp; Tenant Dashboard</span>
            </li>
            <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-8 col-sm-10">
                    <div class="shadow p-3 mb-5 bg-white rounded">
                        <div class="card w-100">
                            <div class="card-body">
                                <h4 class="card-title">Report Maintenance Issue</h4>
                ...
                <div class="col-lg-4 col-md-8 col-sm-10">   
                    <div class="shadow p-3 mb-5 bg-white rounded">
                        <div class="card w-100">
                            <div class="card-body">
                                <h4 class="card-title">My Pending Maint Issues</h4>
                                <p class="card-text">Open and Pending issues.</p>
                                <a href="tenantPendingIssues.php" class="btn btn-primary">View Issues</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8 col-sm-10">
                    <div class="shadow p-3 mb-5 bg-white rounded">
                        <div class="card w-100">
                            <div class="card-body">
                                <h4 class="card-title">My Closed Maint Issues</h4>
                                <p class="card-text">Issue history.</p>
                                <a href="tenantClosedIssues.php" class="btn btn-primary">View History</a>
                            </div>
                        </div>
                    </div>
                </div>
